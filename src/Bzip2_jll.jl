...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Bzip2_jll on Julia versions older than 1.3!")
end
...
artifacts = get_artifacts(artifacts_toml, UUID("6e34b625-4abd-537c-b88f-471c36dfa7a0"))
platforms = get_platforms("Bzip2", artifacts_toml, artifacts)
...
if best_platform === nothing
    @debug("Unable to load Bzip2; unsupported platform $(triplet(platform_key_abi()))")
else
